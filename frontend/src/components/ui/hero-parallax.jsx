...
export const HeroParallax = ({
  ...
  return (
    <div
      ref={ref}
      className="h-[170vh] pt-36 pb-0 overflow-hidden antialiased relative flex flex-col self-auto [perspective:1000px] [transform-style:preserve-3d]">
      <Header />
      <motion.div
        style={{
          rotateX,
...
export const Header = () => {
  return (
    <div
      ...
      <p className="max-w-2xl text-base md:text-xl mt-4 dark:text-neutral-300 text-neutral-300">
